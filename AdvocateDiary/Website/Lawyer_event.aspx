<%@ Page Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true" CodeFile="Lawyer_event.aspx.cs" Inherits="Lawyer_event" %>
...
<asp:Content  runat="server" ID="cphHeader" ContentPlaceHolderID="ContentPlaceHolder1">
    <ul class="site-nav">
      ...
      <li><a href="Lawyer_event.aspx" class="act">Event</a></li>
        ...
        <div style="text-align:right"><font size="3"> Hi  </font> <asp:Label ID="lblHeaderMessage" runat="server" Font-Size="Medium"></asp:Label> 
            ...
            <tr>
                ...
                <td style="height: 31px">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button1" runat="server" Text="Set" CssClass="myButton1" OnClick="Button1_Click" />
                    &nbsp;&nbsp;&nbsp; &nbsp;</td>
            </tr>
            <tr>
                <td style="width: 203px; height: 18px;"></td>
