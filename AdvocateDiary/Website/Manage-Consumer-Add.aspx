<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="Manage-Consumer-Add.aspx.cs" Inherits="Manage_Consumer_Add" %>
...
<asp:Content ID="cMainContent" runat="server" ContentPlaceHolderID="cphMain">
    ...
    <div class="title">Add/Edit Consumer Details<br /><br /></div>
        ...
        <td style="width: 89px; height: 35px;">
            Mobile</td>
        <td style="height: 35px"><asp:TextBox ID="txtMobile" runat="server" CssClass="input300"></asp:TextBox>
            </td>
        </tr>
        <tr>
        <td style="width: 89px">
