<%@ Page Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true" CodeFile="Lawyer_profile.aspx.cs" Inherits="Lawyer_profile" %>
...
&nbsp;<asp:TextBox ID="txtWorkingfield" runat="server" BorderStyle="None" Font-Size="Medium" Height="27px" ReadOnly="True" Width="124px" Font-Bold="True"></asp:TextBox>
                     <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <asp:Label ID="Label6" runat="server" Font-Size="Medium" Text="for"></asp:Label>
&nbsp;<asp:TextBox ID="txtExperience" runat="server" BorderStyle="None" Font-Size="Medium" Height="27px" ReadOnly="True" Width="119px" Font-Bold="False"></asp:TextBox>
                     <br />
&nbsp;&nbsp;&nbsp;
                     <br />
                 </td>
